...
public class DataTransformer {
  ...
  public static func nonRenewingPurchase(nonRenewingPurchase: ApphudNonRenewingPurchase)
    -> NSDictionary
  {
    [
  ...
  public static func apphudPurchaseResult(purchaseResult: ApphudPurchaseResult) -> NSDictionary {
    var map =
      [
        "transaction_id": purchaseResult.transaction?.transactionIdentifier ?? "",
        "product_id": purchaseResult.transaction?.payment.productIdentifier ?? "",
        "subscription_status": purchaseResult.subscription?.isActive() ?? nil,
        "non_renewing_purchase_status": purchaseResult.nonRenewingPurchase?.isActive()
          ?? nil,
        "error": purchaseResult.error?.localizedDescription ?? nil,
